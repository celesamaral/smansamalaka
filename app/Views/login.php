...
<head>
    ...
    <title>Login | SMA Negeri 1 Malaka Barat</title>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="<?= base_url('auth/login') ?>" method="POST">
                                        ...
                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">Username/NIP/NIS</label>
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Tidak memiliki akun? Silahkan kontak admin</p>
                                        </div>
                                    </form>
