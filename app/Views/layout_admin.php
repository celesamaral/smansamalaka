...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?= base_url('assets/img/profile/' . profile()) ?>" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2"><?= admin()->username ?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?= strtoupper(admin()->username) ?></h6>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('admin/guru') ?>">
          <i class="bi bi-people"></i>
          <span>Guru</span>
        </a>
      </li>
        ...
        <ul id="siswa-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?= base_url('admin/siswa/baru') ?>">
              <i class="bi bi-circle"></i><span>Baru Mendaftar</span>
            </a>
          </li>
          <li>
            <a href="<?= base_url('admin/siswa/aktif') ?>">
              <i class="bi bi-circle"></i><span>Siswa Aktif</span>
            </a>
          </li>
        </ul>
      </li>
