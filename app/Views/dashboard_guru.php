    ...
    <div class="row">
        <div class="col-md-4 col-sm-12">
            ...
            <div class="card info-card customers-card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Jumlah <span>| Mata Pelajaran</span></h5>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <h6><?= $mapel_ajar ?></h6>
                            <a href="<?= base_url('guru/mapel') ?>" class="text-primary small pt-1 fw-bold">Lihat Mata Pelajaran >></a>
        ...
        <div class="col-md-4 col-sm-12">
            ...
            <div class="card info-card customers-card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Jumlah <span>| Kelas Diajar</span></h5>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <h6><?= $kelas_ajar ?></h6>
                            <a href="<?= base_url('guru/jadwal') ?>" class="text-primary small pt-1 fw-bold">Lihat Jadwal>></a>
